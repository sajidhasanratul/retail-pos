      ...
      const html = `
        <div class="thermal-receipt">
          <div style="text-align: center; margin-bottom: 8px;">
            <h3 style="margin:0; font-size:16px;">🏪 RETAIL POS</h3>
            <p style="font-size:10px; margin: 2px 0 0 0;">123 Market Street, Dhaka</p>
            <p style="font-size:10px; margin: 1px 0 0 0;">Phone: 01700000000</p>
          </div>
          <hr>
          ...
          <div style="text-align: center; margin-top: 25px; font-size: 10px;">
            ...
            <p style="font-size: 9px; margin-top:4px; color:#555;">Software by RetailPOS</p>
          </div>
        </div>
      `;
