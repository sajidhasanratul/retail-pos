          ...
          <div class="product-card fade-in" data-id="${p.id}">
            ...
            <div class="product-card-body">
              ...
              <div class="product-card-actions">
                <button class="btn btn-secondary btn-sm btn-edit-prod" style="flex:1;">✏️ Edit Details</button>
                <button class="btn btn-secondary btn-sm btn-delete-prod" style="color:var(--danger)">🗑️ Delete</button>
              </div>
            </div>
          </div>
        `;
